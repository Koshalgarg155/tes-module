...
{
    [DbContext(typeof(GiiftCatalogModuleDbContext))]
    [Migration("20231018065139_ExtendCategoryItemRelation")]
    partial class ExtendCategoryItemRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VirtoCommerce.CatalogModule.Data.Model.CategoryItemRelationEntity", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("CategoryItemRelationEntity");
                });
            ...
            modelBuilder.Entity("Giift.GiiftCatalogModule.Data.Models.ExtendedCategoryItemRelationEntity", b =>
                {
                    b.HasBaseType("VirtoCommerce.CatalogModule.Data.Model.CategoryItemRelationEntity");

                    b.Property<bool>("IsItemRelationActive")
                        .HasColumnType("bit");

                    b.HasDiscriminator().HasValue("ExtendedCategoryItemRelationEntity");
                });
